...
class appTestUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // app_default_matrix
        if (preg_match('#^/(?P<project>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_default_matrix')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::matrixAction',));
        }
